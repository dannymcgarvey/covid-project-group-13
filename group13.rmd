...
plot(new_cases, type="l", main="Daily New Covid-19 Cases in the US", xlab = "Days since January 22, 2020", ylab = "New Cases")
...
Black lines are dates on which the weekly total cases started increasing
...
# since i started at 8, the new graph starts at January 29 instead of January 22.
start_date <- "2020-01-29"

plot(rate_of_change, type="l", main = "Change in weekly total of US Covid-19 Cases", xlab = "Days Since January 29, 2020", ylab = "Change in Weekly Total Cases")
abline(h=0)
...
# ignore the first 40 days, we are not interested in these
for (i in seq(40, length(rate_of_change))) {
...
# plot lines at the dates on which the rate of change became positive
for (i in seq(length(zeroes))) {
  abline(v=zeroes[i]-as.Date(start_date))
